...
class DeGiroConverterAccount:
    EXPORT_COLUMNS = ["Date", "ISIN", "value", "shares", "Fees", 'Transaction Currency']
    ...
    def filter_input(self):
        df = self.inputdata
        df = df[ (df['Omschrijving'] == "Dividend") | (df['Omschrijving'] == "iDEAL storting") ]
        return df
...
if __name__ == '__main__':
    ...
    converter.convert()
    converter.write_outputfile(os.path.dirname(sys.argv[0]), 'degiro_account_converted.csv')
